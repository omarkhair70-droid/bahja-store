  ...
  return (<>
    <section className="mx-auto grid w-full max-w-6xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-2 lg:py-14 lg:px-8">
      <div className="space-y-6">
        ...
        <h1 className="editorial-heading">A global feminine boutique, handmade with soul.</h1>
        ...
        <p className="text-xs uppercase tracking-[0.15em] text-bahja-taupe">Handmade in Cairo • Made to order • Custom colors & finishing</p>
      </div>
    ...
    <SectionShell title="Choose your story"><div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">{[
      { title: 'شنط هاند ميد', href: '/shop?category=handmade-bags', image: '/images/bahja/bags-himalayan-thread/himalayan-thread-bag-teal-gold-chain-01.webp', desc: 'Explore handcrafted bags with warm, detailed threadwork.', cta: 'Shop handmade bags' },
      { title: 'لوحات كانفس', href: '/shop?category=canvas-art', image: '/images/bahja/canvas-art/canvas-arabic-calligraphy-floral-01.webp', desc: 'Discover poetic canvas pieces inspired by Arabic art.', cta: 'View canvas pieces' },
      { title: 'إكسسوارات شعر', href: '/shop?category=hair-accessories', image: '/images/bahja/hair-accessories/satin-hair-accessories-royal-blue-02.webp', desc: 'Find satin accessories for graceful everyday styling.', cta: 'Browse accessories' },
